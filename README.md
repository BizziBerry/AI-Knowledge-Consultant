...
##  🤖 Интерактивный чат-интерфейс для общения с консультантом

### Новые возможности:
- ✅ Интерактивный чат-интерфейс для общения с консультантом
- ✅ Простой и понятный UI с полем ввода и отображением ответов
- ✅ Поддержка примеров вопросов для быстрого старта
- ✅ Публичная ссылка для демонстрации (share=True)

![Добавление книги](screenshots/nc.jpg)
